...
const EmployeePage = () => {
  ...
  } = useSWR(['/api/employee', token], getAllEmployeeData);
  ...
  const atSubmit = useCallback(
    async (e: React.MouseEvent) => {
      e.preventDefault();
      setIsLoading(true);
      const res = await axios.post('/api/employee/register', newEmployee, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
                          ...
                          <div className='flex justify-between gap-2'>
                            <div>
                              <Input
                                ...
                                required
                                onChange={(e) => updateNewEmployee(e)}
                                defaultValue={newEmployee.emergencyName}
                                placeholder='姓名'
                              />
                            </div>
                            <div>
                              <Input
                                ...
                                required
                                onChange={(e) => updateNewEmployee(e)}
                                defaultValue={newEmployee.emergencyRelationship}
                                placeholder='關係'
                              />
                            </div>
                            <div>
                              <Input
                                ...
                                required
                                onChange={(e) => updateNewEmployee(e)}
                                defaultValue={newEmployee.emergencyPhone}
                                placeholder='電話'
                              />
                            </div>
                          </div>
                      ...
                      <div className='flex flex-col gap-y-3'>
                        ...
                        {/* <div>
                          ...
                          <div className='flex gap-2'>
                            <DatePicker
                              openDatePicker={dateOpenBirthday}
                              setOpenDatePicker={setDateOpenBirthday}
                              defaultDate={newEmployee.birthday}
